...
/**
 * Imagina que estás trabajando en una aplicación de gestión de inventario para una 
 * tienda en línea. Tu tarea es manejar una secuencia de productos que llegan al 
 * almacén y quieres filtrar solo los productos que están en stock y tienen un 
 * precio superior a $50 para mostrarlos en la página principal de la tienda.
 */
